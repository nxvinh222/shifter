...
const languageKeys = {"keys":["language","lang","locale","userLanguage","i18n.locale","currentLanguage"]};
...
module.exports = { detectLanguage, checkStorageForLanguage, updateLanguage, updateStorageWithLanguage };
